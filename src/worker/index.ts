...
// 1. Ruta para security.txt
app.get('/.well-known/security.txt', (c) => {
  const securityTxt = `# RFC 9116 - https://securitytxt.org/
Contact: mailto:seguridad@huracanescomodoro.com.ar
Encryption: https://huracanescomodoro.com.ar/.well-known/pgp-key.txt
Policy: https://huracanescomodoro.com.ar/seguridad/politica
...
Preferred-Languages: es`
  ...
  // Hono tiene un método específico para devolver texto plano
  return c.text(securityTxt)
})

// 2. Ruta para la clave PGP
app.get('/.well-known/pgp-key.txt', (c) => {
...
-----END PGP PUBLIC KEY BLOCK-----`
  ...
  return c.text(pgpKey)
})

// ... el resto de tus rutas de Hono (ej. /api/name) ...
